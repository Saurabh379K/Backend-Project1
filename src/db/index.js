...
where the program waits for the database query to complete before moving on.
So, we should async/await which allows for non-blocking execution
enabling the program to continue with other tasks while waiting for the database response. 
